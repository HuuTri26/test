    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="examhistory.html">Booking Details</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="table datatable">
                <thead style="background-color: #37517e; color: white">
                  <tr>
                    ...
                    <th scope="col">Maid Time Slots</th>
                    <th scope="col">Maid Holidays</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td scope="row">1</td>
                    <td scope="col">Maid ID</td>
                    <td scope="col">User ID</td>
                    <td scope="col">Services ID</td>
                  ...
                  <tr>
                    ...
                    <td scope="col">Time</td>
                    <td scope="col">Days</td>
                    <td scope="col"><a href="update_exam.html" class="btn btn-primary">Update</a><a href="#" class="btn btn-danger">delete</a></td>
                  </tr>
                  <tr>
                    <td scope="row">3</td>
                    <td scope="col">Maid ID</td>
