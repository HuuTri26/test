    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="subject.html">Services</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              <div class="card-title">
                <a href="addService.htm" class="btn btn-primary">Add Service</a>
              </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td scope="col"><a href="update_subject.html"  class="btn btn-primary "><i class="bi-pencil"></i></a><a href="#" class="btn btn-danger"><i class="bi-trash"></i></a></td>
                  </tr>
                  <tr>
                    <td scope="row">2</td>
                    <td scope="col">Service Name</td>
