...
<!--       </aside>End Sidebar -->
   ...
   -->
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">Subject Name</label>
                                    <input type="text" class="form-control" id="validationDefault01" value="" name="first_name" placeholder="Subject name"
                                        required>
                                </div>
                                <div class="col-md-6"></div>
                                 <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">Price/day</label>
